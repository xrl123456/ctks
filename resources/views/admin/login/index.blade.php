    ...
    <div id="mws-login-wrapper">
        <div id="mws-login">
            ...
            <div id="mws-login-form">
                <form class="mws-form" action="/admins/login" method="post">
                	{{ csrf_field() }}
                    <div class="mws-form-row">
                        <div class="mws-form-item">
                            <input type="text" name="name" value="{{ old('name') }}" class="mws-login-username required" placeholder="请输入您的账号">
                        </div>
                    </div>
                    <div class="mws-form-row">
                        <div class="mws-form-item">
                            <input type="password" name="password" value="{{ old('password') }}" class="mws-login-password required" placeholder="请输入您的密码">
                        </div>
                    </div>
                    <div id="mws-login-remember" class="mws-form-row mws-inset">
                        <ul class="mws-form-list inline">
                            ...
                            <a href="/admins/seek/" style="float:right;">忘记密码</a>
                        </ul>
                    </div>
                    <div>
                    	@if (count($errors) > 0)
