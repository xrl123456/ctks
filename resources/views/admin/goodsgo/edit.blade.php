                        	...
                        	<div class="mws-form-inline">
                            	<div class="mws-form-row">
                                	...
                                	<div class="mws-form-item">
                                    	<input style="width:500px;" type="text" name="gname" value="{{ $goods->gname }}" placeholder="请输入商品名称" class="required large">
                                    </div>
                                </div>
                            	...
                            	<div class="mws-form-row">
                                	...
                                	<div class="mws-form-item">
                                    	<input style="width:500px;" value="{{ $goods->price }}"  maxlength="8" type="text" placeholder="商品价格长度限制8位数" name="price" class="required email large">
                                    </div>
                                </div>
                            	<div class="mws-form-row">
                                	<label class="mws-form-label"><h4>商品库存</h4></label>
                                	<div class="mws-form-item">
                                    	<input style="width:500px;"  maxlength="8"  value="{{ $goods->goodsNum }}" type="text" name="goodsNum" placeholder="库存长度限制8位数"class="required url large">
                                    </div>
                                </div>
                            	<div class="mws-form-row">
                                	<label class="mws-form-label"><h4>商品描述</h4></label>
                                	
                                    	<textarea name="goodsinfo" id="" cols="30" rows="10"  onkeyup="check(this)" placeholder="商品描述限制60个字" maxlength="60">{{ $goods->goodsinfo }}</textarea>
                            	...
                            	<div class="mws-form-row">
                                    ...
                                    <div class="mws-form-item">
                                        ...
                                        @foreach($type as $k=>$v)
                                            <option value="{{$v->id }}" {{$v->id==$goods->tid?'selected':''}}>{{$v->cname }}</option>
                                         @endforeach
                                        </select>
                                    </div>
                                </div>
                            	<div class="mws-form-row">
                                	...
                                	<div class="mws-form-item">
                                    	<div class="fileinput-holder" style="position: relative;">
                                            ...
                                            <h5>上传图片：</h5>
                                            <input type="file" name="pic"   value="{{ $goods->pic }}"class="required" style="position: absolute; top: 0px; right: 0px; margin: 0px; cursor: pointer; font-size: 999px; opacity: 0; z-index: 999;">
                                            </span>
                                        </div>
