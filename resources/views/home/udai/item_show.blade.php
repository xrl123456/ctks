		...
		<section class="item-show__div item-show__head clearfix">
			...
			<div class="pull-left">
				<ol class="breadcrumb">
					...
					<li class="active">{{ $itemShow->goodsinfo }}</li>
				</ol>
				<div class="item-pic__box" id="magnifier">
					<div class="small-box">
						<img class="cover" src="/uploads/Goods/{{ $itemShow->pic }}" alt="重回汉唐 旧忆 原创设计日常汉服女款绣花长褙子吊带改良宋裤春夏">
					...
					<div class="big-box"><img src="/uploads/Goods/{{ $itemShow->pic }}" alt="重回汉唐 旧忆 原创设计日常汉服女款绣花长褙子吊带改良宋裤春夏"></div>
				...
				<div class="item-info__box">
					<div class="item-title">
						<div class="name ep2">{{ $itemShow->goodsinfo }}</div>
						<div class="sale cr">优惠活动：该商品享受8折优惠</div>
					</div>
					<div class="item-price bgf5">
						<div class="price-box clearfix">
							<div class="price-panel pull-left">
								售价：<span class="price">￥{{ $itemShow->price }}</span>
							</div>
							<div class="vip-price-panel pull-right">
								会员等级价格 <i class="iconfont icon-down"></i>
								<ul class="all-price__box">
									<!-- 登陆后可见 -->
									<li><span class="text-justify">普通：</span>{{$itemShow->price}}元</li>
									<li><span class="text-justify">银牌：</span>{{$itemShow->price * 0.9 }}元</li>
									<li><span class="text-justify">超级：</span>{{$itemShow->price * 0.5 }}元</li>
									<li><span class="text-justify">V I P：</span>{{$itemShow->price * 0.2 }}元</li>
								</ul>
							</div>
							<script>
								// 会员价格折叠展开
