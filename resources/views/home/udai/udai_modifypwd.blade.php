...
@section('content')
		<div class="pull-right">
				<div class="user-content__box clearfix bgf">
					...
					<form action="/home/modifypwd" class="user-setting__form"   method="post" role="form">
						<div class="form-group">
						 {{ csrf_field() }}
                            
							<input class="form-control" name="password" required="" maxlength="11" autocomplete="off" type="password">
